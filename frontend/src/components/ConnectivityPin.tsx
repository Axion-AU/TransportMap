    ...
    return (
        <>
            <Marker position={[pin.lat, pin.lng]} icon={pinIcon}>
                <Popup minWidth={typeof window !== 'undefined' && window.innerWidth < 768 ? 260 : 320} maxWidth={typeof window !== 'undefined' && window.innerWidth < 768 ? 280 : 360}>
                    <div className="text-sm font-sans select-none">
                        ...
                        <div className="max-h-[50vh] md:max-h-none overflow-y-auto pr-1">
                            {pin.score < 50 && (
